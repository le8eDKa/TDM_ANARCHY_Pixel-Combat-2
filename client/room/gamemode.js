...
//все работает :)
//я кое чо сделал через чат гпт и всю полетело не появляется красная ккоманда и не могу зайти в синию исправь пж код :(
...
// Установки для работы с уронами и командами
