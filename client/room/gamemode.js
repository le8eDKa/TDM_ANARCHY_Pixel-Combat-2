/*
	...
	> Кто унёс?...
	> Ну и ещё: я не могу зайти в игру сейчас, тестировать тебе придётся самому. Обнови режим.
	> Синтаксическую ошибку исправил, должно работать. И не используй больше GPT лучше...
	> А то накосячишь больше... 
	<кусок кода ,и да больше не буду я же специально сделал модульно чтоб закоментировать потом
