...
// Я попробовал, код работает как надо, наконец-то можно убрать его последствия ChatGPT, я ему не доверяю свои коды теперь >:( 
// А ты? И кстати с Наступающим новым годом тебя!
// И тебя с наступающим ;) Я никогда и не доверял ChatGPT.
